// V2.9 foreground refinement. It retains the tested gameplay contract while
// tightening the bow silhouette, material layers, glove detail and arm posing.
...
makeCityWeapon=function(){
 ...
 // Dark riser side plates and a small reinforced shelf add a readable, usable
 // construction rather than a featureless wooden center block.
 loft(weaponBow,[[-.013,.605,.046,.023,.003],[-.006,.690,.052,.025,.003],[.021,.770,.033,.019,.003],[.028,.845,.010,.015,.003]],M.black,4);
 box(weaponBow,[.047,.029,.010],[-.004,.746,.044],M.steel);
 box(weaponBow,[.022,.048,.012],[.034,.865,-.018],M.black);
 ...
 for(const y of [.535,.712])loft(weaponBow,[[-.007,y,.017,.037,.043],[-.007,y+.014,.017,.037,.043]],M.black,8);
 ...
 tube(weaponArrow,[[0,0,-.03],[0,0,.004]],[.0062,.0062],M.black,6);

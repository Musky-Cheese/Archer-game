// V2.8a local foreground-motion study. It keeps the tested V2.6.1 geometry
// and gameplay contract, while making the first-person draw arm feel connected
// to the player: weight transfer, breathing, stride, draw tension and release.
...
var heroWeapon={limbs:[],rightSegments:[],pull:0,reviewPose:null,drawFingers:[],exports:[],motion:{breath:0,walk:0,recoil:0}};
